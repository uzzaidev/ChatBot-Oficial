                                          ...
                                          <div className="flex max-w-[280px] flex-wrap justify-end gap-1">
                                            {cardTags.slice(0, 3).map((tag) => (
                                              <span
                                                ...
                                                style={{
                                                  backgroundColor: `${tag.color === "blue" ? "#3b82f6" : tag.color === "green" ? "#22c55e" : tag.color === "red" ? "#ef4444" : tag.color === "yellow" ? "#eab308" : tag.color === "purple" ? "#a855f7" : tag.color === "pink" ? "#ec4899" : tag.color === "orange" ? "#f97316" : tag.color === "cyan" ? "#06b6d4" : "#6b7280"}20`,
                                                  borderColor: `${tag.color === "blue" ? "#3b82f6" : tag.color === "green" ? "#22c55e" : tag.color === "red" ? "#ef4444" : tag.color === "yellow" ? "#eab308" : tag.color === "purple" ? "#a855f7" : tag.color === "pink" ? "#ec4899" : tag.color === "orange" ? "#f97316" : tag.color === "cyan" ? "#06b6d4" : "#6b7280"}33`,
                                                  color:
                                                    tag.color === "yellow"
                                                      ? "#fde68a"
                                                      : "#f8fafc",
