  ...
  return (
    <div className="text-center">
      ...
      <p className="text-gray-600 mb-6 text-sm">
        Para começar, conecte sua conta do WhatsApp Business. Uma janela do Meta
        será aberta para autorizar o acesso.
      </p>
      ...
      <EmbeddedSignupButton
        ...
        onSuccess={(data) => onConnected(data.clientId)}
      ...
      <div className="w-full max-w-lg">
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8">
          ...
          {currentStep === "connect-whatsapp" && (
            <ConnectWhatsAppStep
              clientId={clientId}
              onConnected={(returnedClientId) => {
                const params = new URLSearchParams({
                  step: "whatsapp-connected",
