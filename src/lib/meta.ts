...
export const sendTextMessage = async (
  ...
  try {
    ...
    const errorMessage =
      error instanceof Error ? error.message : "Unknown error";
    throw new Error(
      `Failed to send text message via Meta API: ${errorMessage}`,
    );
  }
};
...
export const markMessageAsRead = async (messageId: string): Promise<void> => {
  try {
    ...
    const errorMessage =
      error instanceof Error ? error.message : "Unknown error";
    throw new Error(
      `Failed to mark message as read via Meta API: ${errorMessage}`,
    );
  }
};
...
export const sendImageMessage = async (
  ...
  try {
    ...
    const errorMessage =
      error instanceof Error ? error.message : "Unknown error";
    throw new Error(
      `Failed to send image message via Meta API: ${errorMessage}`,
    );
  }
};
...
export const sendAudioMessage = async (
  ...
  try {
    ...
    const errorMessage =
      error instanceof Error ? error.message : "Unknown error";
    throw new Error(
      `Failed to send audio message via Meta API: ${errorMessage}`,
    );
  }
};
...
export const sendAudioMessageByMediaId = async (
  ...
  try {
    ...
    const errorMessage =
      error instanceof Error ? error.message : "Unknown error";
    throw new Error(
      `Failed to send audio message by media ID via Meta API: ${errorMessage}`,
    );
  }
};
...
export const sendDocumentMessage = async (
  ...
  try {
    ...
    const errorMessage =
      error instanceof Error ? error.message : "Unknown error";
    throw new Error(
      `Failed to send document message via Meta API: ${errorMessage}`,
    );
  }
};
...
export const sendTemplateMessage = async (
  ...
  try {
    ...
    const errorMessage =
      error?.response?.data?.error?.message || error.message || "Unknown error";
    throw new Error(
      `Failed to send template message via Meta API: ${errorMessage}`,
    );
  }
};
...
export const syncTemplateStatus = async (
  ...
  try {
    ...
    for (const name of templateNames) {
      ...
      if (template) {
        ...
        if (template.status === "REJECTED") {
          ...
          statusMap[name].rejection_reason =
            (detailed as any).rejection_reason || "No reason provided";
        }
      }
    }
    ...
    const errorMessage =
      error?.response?.data?.error?.message || error.message || "Unknown error";
    throw new Error(
      `Failed to sync template status from Meta API: ${errorMessage}`,
    );
  }
};
