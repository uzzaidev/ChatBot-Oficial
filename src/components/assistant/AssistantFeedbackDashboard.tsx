...
function truncate(str: string | null, n = 120): string {
  if (!str) return "—";
...
export function AssistantFeedbackDashboard() {
  ...
  const load = useCallback(async () => {
    ...
    try {
      ...
      const res = await fetch(`/api/assistant/feedback?${params}`);
              ...
              <tbody>
                {rows.map((row, i) => (
                  ...
                  >
                    ...
                    <td className="max-w-[280px] px-4 py-2.5 text-foreground">
                      <ExpandableText text={row.response} />
                    </td>
                    ...
                    <td className="max-w-[160px] px-4 py-2.5">
                      {row.sql_query ? (
                        <ExpandableText text={row.sql_query} />
                      ) : (
                        <span className="text-muted-foreground/40">—</span>
                      )}
                    </td>
