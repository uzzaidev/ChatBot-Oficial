      ...
      const res = await apiFetch(`/api/agents/${agentId}/qa/reports`, {
        ...
        body: JSON.stringify({
          ...
          agent_snapshot: {
            ...
            enable_human_handoff: agent.enable_human_handoff,
            enable_document_search: agent.enable_document_search,
            enable_audio_response: agent.enable_audio_response,
            enable_contact_registration: agent.enable_contact_registration,
            enable_calendar_tools: agent.enable_calendar_tools,
