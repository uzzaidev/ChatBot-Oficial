      ...
      {conversations.map((conversation) => {
        ...
        return (
          <div
            ...
            className={cn(
              "group relative p-4 cursor-pointer transition-all duration-200 border-b border-border/50 overflow-hidden",
              isActive
          ...
          >
            <div className="flex items-start gap-3">
              ...
              <div className="relative flex-shrink-0">
                <div className="h-8 w-8 rounded-full flex items-center justify-center font-semibold text-white text-xs bg-gradient-to-br from-secondary to-primary">
