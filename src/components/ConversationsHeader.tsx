...
export const ConversationsHeader = ({
  ...
  return (
    <div
      className="w-full border-b border-white/5 px-4 md:px-6 py-3 md:py-4"
      style={{ background: 'rgba(28, 28, 28, 0.98)' }}
    >
      {/* Header Top - Título e Status */}
      <div className="flex items-center justify-between mb-3 md:mb-4">
        <div>
          <h1 className="font-poppins font-bold text-lg md:text-2xl text-white mb-0.5 md:mb-1">
            Caixa de Entrada
          </h1>
        ...
        <div className="flex items-center gap-2 px-2 md:px-4 py-1.5 md:py-2 bg-[#151515] rounded-lg border border-white/10">
          <div className="w-2 h-2 bg-[#1ABC9C] rounded-full animate-pulse shadow-lg shadow-[#1ABC9C]/50" />
          <span className="text-white/70 text-xs md:text-sm font-medium hidden sm:inline">Sistema Online</span>
        </div>
      </div>
      ...
      <div className="overflow-x-auto pb-2 -mx-4 px-4 md:mx-0 md:px-0 md:pb-0 md:overflow-visible">
        <div className="grid grid-flow-col auto-cols-[minmax(140px,1fr)] md:grid-flow-row md:grid-cols-3 lg:grid-cols-5 gap-3 md:gap-4 min-w-max md:min-w-0">
        {/* Card TODAS */}
        <button
          onClick={() => onStatusChange('all')}
          className={cn(
            "relative p-3 md:p-4 rounded-xl border transition-all duration-200 text-left group",
            statusFilter === 'all'
        ...
        >
          <div className="flex items-start justify-between mb-2 md:mb-3">
            ...
            <MessageCircle className="h-4 w-4 md:h-5 md:w-5 opacity-40 group-hover:opacity-60 transition-opacity" style={{ color: '#1ABC9C' }} />
          </div>
          <div className="font-exo2 text-2xl md:text-3xl font-bold text-white mb-0.5 md:mb-1">
            {metrics.total}
          </div>
          <div className="text-[10px] md:text-xs text-white/40 truncate">Total de conversas</div>
        </button>
        ...
        >
          <div className="flex items-start justify-between mb-2 md:mb-3">
            ...
            <Bot className="h-4 w-4 md:h-5 md:w-5 opacity-40 group-hover:opacity-60 transition-opacity flex-shrink-0" style={{ color: '#2E86AB' }} />
          </div>
          <div className="font-exo2 text-2xl md:text-3xl font-bold text-white mb-0.5 md:mb-1">
            {metrics.bot}
          </div>
          <div className="text-[10px] md:text-xs text-white/40 truncate">Bot ativo</div>
        </button>
        ...
        >
          <div className="flex items-start justify-between mb-2 md:mb-3">
            ...
            <User className="h-4 w-4 md:h-5 md:w-5 opacity-40 group-hover:opacity-60 transition-opacity" style={{ color: '#1ABC9C' }} />
          </div>
          <div className="font-exo2 text-2xl md:text-3xl font-bold text-white mb-0.5 md:mb-1">
            {metrics.humano}
          </div>
          <div className="text-[10px] md:text-xs text-white/40 truncate">Atend. humano</div>
        </button>
        ...
        >
          <div className="flex items-start justify-between mb-2 md:mb-3">
            ...
            <Workflow className="h-4 w-4 md:h-5 md:w-5 opacity-40 group-hover:opacity-60 transition-opacity" style={{ color: '#9b59b6' }} />
          </div>
          <div className="font-exo2 text-2xl md:text-3xl font-bold text-white mb-0.5 md:mb-1">
            {metrics.emFlow}
          </div>
          <div className="text-[10px] md:text-xs text-white/40 truncate">Flow interativo</div>
        </button>
        ...
        >
          <div className="flex items-start justify-between mb-2 md:mb-3">
            ...
            <ArrowRight className="h-4 w-4 md:h-5 md:w-5 opacity-40 group-hover:opacity-60 transition-opacity flex-shrink-0" style={{ color: '#fb923c' }} />
          </div>
          <div className="font-exo2 text-2xl md:text-3xl font-bold text-white mb-0.5 md:mb-1">
            {metrics.transferido}
          </div>
          <div className="text-[10px] md:text-xs text-white/40 truncate">Aguardando</div>
        </button>
      </div>
      </div>
    </div>
