...
export const SendMessageForm = ({
  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      <div className="flex items-end gap-2 bg-surface border border-border rounded-lg p-2 w-full overflow-hidden">
        ...
        {!isRecording && !hasRecordedAudio && (
          <textarea
            ...
            disabled={sending}
            className="flex-1 min-w-0 resize-none border-0 bg-transparent px-3 py-2 text-sm md:text-base text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-0 rounded-lg max-h-[120px] min-h-[40px]"
            rows={1}
          />
        )}
