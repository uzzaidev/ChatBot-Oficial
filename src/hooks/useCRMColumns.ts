...
interface UseCRMColumnsResult {
  ...
  loading: boolean
  error: string | null
  createColumn: (data: { name: string; color?: string; icon?: string }) => Promise<CRMColumn | null>
  updateColumn: (id: string, data: { name?: string; color?: string; icon?: string }) => Promise<CRMColumn | null>
  deleteColumn: (id: string) => Promise<boolean>
  reorderColumns: (columnOrders: Array<{ id: string; position: number }>) => Promise<boolean>
