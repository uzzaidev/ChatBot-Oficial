...
- [x] **3.4: Biometric Auth** ✅
    - [x] Planejamento completo ✅ (documento criado)
    - [x] Instalar plugin `@aparajita/capacitor-biometric-auth` ✅
    - [x] Criar `src/lib/biometricAuth.ts` ✅
    - [x] Criar `src/components/BiometricAuthButton.tsx` ✅
    - [x] Integrar no login page ✅
    - [x] Sync com Capacitor ✅
    - [ ] Testar em device físico (biometria não funciona em emulador)
